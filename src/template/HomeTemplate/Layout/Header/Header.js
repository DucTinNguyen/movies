...
export default function Header() {
    ...
    //Lấy thông tin người dùng sau khi đăng nhập rồi
    ...
    const renderLogin = () => {
        if (_.isEmpty(userLogin)) {
            ...
            return <button className="self-center px-8 py-3 rounded">
            <NavLink to="/profile">Hello {userLogin.taiKhoan}</NavLink>
        </button>
        }
    ...
    return (
        <header className="p-4 text-white bg-black/80 fixed w-full z-50">
            <div className="container flex justify-between h-16 mx-auto">
                <NavLink rel="noopener noreferrer" to="/" aria-label="Back to homepage" className="flex items-center p-2">
                    ...
                    <img className="max-w-full" src="https://www.cgv.vn/skin/frontend/cgv/default/images/cgvlogo.png" alt='1234' />

                </NavLink>
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <NavLink rel="noopener noreferrer" to="/home" activeClassName="border-b-2 border-cyan-400" className="flex items-center px-4 -mb-1 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Home</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink rel="noopener noreferrer" to="/contact" activeClassName="border-b-2 border-cyan-400" className="flex items-center px-4 -mb-1 dark:border-transparent">Contact</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink rel="noopener noreferrer" to="/news" activeClassName="border-b-2 border-cyan-400" className="flex items-center px-4 -mb-1 dark:border-transparent">News</NavLink>
                    </li>
                </ul>
