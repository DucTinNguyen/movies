...
export default function Footer() {
    ...
    // console.log(listCinestar)
    let arrListCinestar =  _.map(listCinestar, (item) =>_.pick(item,['tenHeThongRap','logo']))
            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Nguyễn Đức Tín</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1 grid grid-cols-3">
                            {arrListCinestar.map((item,index) =>{
                                return <li key={index} style={{width:50,height:50}}>
